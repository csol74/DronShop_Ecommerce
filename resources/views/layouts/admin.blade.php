...
<div class="admin-layout">
    ...
    <aside class="admin-sidebar">
        ...
        <div class="admin-sidebar__section">Operaciones</div>

        <a href="{{ route('admin.dron.index') }}"
        class="admin-nav-link {{ request()->routeIs('admin.dron.*') ? 'active' : '' }}">
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <a href="{{ route('admin.dron.monitoreo') }}"
        class="admin-nav-link {{ request()->routeIs('admin.dron.monitoreo') ? 'active' : '' }}">
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        class="admin-nav-link {{ request()->routeIs('admin.mantenimiento.*') ? 'active' : '' }}">
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="admin-sidebar__section">Usuarios y Roles</div>
